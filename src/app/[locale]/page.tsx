    ...
    <section className="mx-auto max-w-5xl text-center space-y-10">
      <header className="space-y-4">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link href={`/${locale}/pricing`} className="rounded-xl border border-white/15 px-5 py-3 text-sm hover:bg-white/10">
            {t('cta.pricing')}
          </Link>
          <Link href={`/${locale}/donate`} className="rounded-xl border border-white/15 px-5 py-3 text-sm hover:bg-white/10">
            {t('nav.donate')}
          </Link>
        </div>
      </header>
