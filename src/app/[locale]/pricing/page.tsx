    ...
    <section className="pt-16 md:pt-24 pb-12 md:pb-16">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-10 flex flex-col gap-4 md:flex-row md:justify-center md:gap-6">
          <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-zinc-950/60 px-6 py-6 mx-auto md:mx-0">
        ...
        <ul className="mt-3 space-y-1 opacity-90 list-disc pl-6 max-w-2xl mx-auto text-left">
          {features.map((f, i) => (
            <li key={i}>{f}</li>
          ))}
        </ul>
